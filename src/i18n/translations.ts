...
export const translations = {
  ar: {
    ...
    noteVisibilityHint: 'هذه الملاحظة تبقى خاصة بين المسؤولين، ولا يطّلع عليها الموظف المعنيّ.',
    evaluation: 'التقييم',
    rating: 'التقييم',
    comment: 'تعليق',
  ...
  en: {
    ...
    noteVisibilityHint: 'This note stays private between supervisors — the employee it concerns cannot see it.',
